...
/*xmlrpcParser.parseResponseXml = function(xml) {
  deserializeParams(xml, function() {
...
/*function deserializeParams(xml, callback) {
  ...
  var saxParser = new xmlParser.SaxParser(function(res) {
    ...
    res.onEndElementNS(function(element, prefix, uri) {
      switch (element) {
        case: 'param':
          params.push(param)
        break
    ...
    res.onCharacters(function(chars) {
...
function deserializeParam(xml, callback) {
