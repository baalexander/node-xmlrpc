...
exports.deserializeMethodResponse = function(stream, cb) {
  var u;
  ...
  u = new Deserializer(stream, on_result);
}

exports.deserializeMethodCall = function(stream, cb) {
  var u;
  function on_result(error, result) {
    if ( ! error ) {
...
var Deserializer = function(stream, cb) {
  this._type = null
