...
xmlrpcParser.captureStream = function (chars) {
  xmlrpcParser.stream += chars
}

xmlrpcParser.fetchStream = function () {
  var trimmedStream = xmlrpcParser.stream.trim()
  xmlrpcParser.stream = ""
  ...
  parser.onStartElementNS(function(element, attributes, prefix, uri, namespaces) {
    if (element === 'methodName') {
      parser.onCharacters(function(method) {
        xmlrpcParser.captureStream(method)
      })
      
      parser.onEndElementNS(function() {
        callback(null, xmlrpcParser.fetchStream(), parser)
      })
    }
  })
}
  ...
  parser.onStartElementNS(function(element, attributes, prefix, uri, namespaces) {
    ...
    if (isFlatParam) {
      ...
      parser.onCharacters(function(chars) {
        ...
        xmlrpcParser.captureStream(chars)
      })
      ...
      parser.onEndElementNS(function(element, prefix, uri) {
        var message = xmlrpcParser.fetchStream()
